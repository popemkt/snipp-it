...
using FSH.API.Application.Common.Exceptions;
using FSH.API.Application.Common.FileStorage;
using FSH.API.Application.Common.Interfaces;
using FSH.API.Application.Common.Mailing;
using FSH.API.Application.Common.Models;
using FSH.API.Application.Common.Specification;
using FSH.API.Application.Identity.Users;
using FSH.API.Domain.Identity;
...
namespace FSH.API.Infrastructure.Identity;
